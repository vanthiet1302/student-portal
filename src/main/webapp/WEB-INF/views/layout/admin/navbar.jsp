    ...
    <div class="ms-auto d-flex gap-2 pe-3">
        ...
        <div class="dropdown">
            <button class="btn btn-sm btn-outline-secondary dropdown-toggle"
                ...
                <span data-i18n="theme.current" id="themeLabel">
                    <fmt:message key="theme.current"/>
                </span>
            </button>
            ...
            <ul class="dropdown-menu dropdown-menu-end ms-3">
                <li>
                    <button class="dropdown-item"
                        ...
                        <span data-i18n="theme.light">
                                    <fmt:message key="theme.light"/>
                                </span>
                    </button>
                </li>
                <li>
                ...
                <li>
                    <button class="dropdown-item"
                        ...
                        <span data-i18n="theme.auto">
                                    <fmt:message key="theme.auto"/>
                                </span>
                    </button>
                </li>
            </ul>
