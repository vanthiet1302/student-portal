...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 data-i18n="admin.title.academicClass.add"><fmt:message key="admin.title.academicClass.add"/></h2>
            ...
            <form action="${pageContext.request.contextPath}/admin/academic-classes/add" method="post" class="needs-validation" novalidate>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="code" name="code"
                           value="${requestScope.code}" required>
                    ...
                    <select class="form-control" id="facultyId" name="facultyId" required>
                        ...
                        <c:forEach var="faculty" items="${requestScope.faculties}">
                            <option value="${faculty.id}"
                                    <c:if test="${faculty.id == requestScope.facultyId}">selected</c:if>>
                                ${faculty.name}
                            </option>
                        </c:forEach>
                    </select>
                    ...
                    <select class="form-control" id="advisorId" name="advisorId">
                        ...
                        <c:forEach var="lecturer" items="${requestScope.lecturers}">
                            <option value="${lecturer.userId}"
                                    <c:if test="${lecturer.userId == requestScope.advisorId}">selected</c:if>>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nienKhoa" name="nienKhoa"
                           placeholder="2025-2029" value="${requestScope.nienKhoa}" required>
